...
## Rules
- Create new files only inside valid zones.
- If you must create anything outside these zones, stop and ask the user for explicit confirmation.
- Keep structure and naming consistent with `architect.md`.
