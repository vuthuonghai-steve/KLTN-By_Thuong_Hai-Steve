# PayloadCMS v3 — Field Types Reference

> Nguồn: PayloadCMS v3 Official Docs
> Mục đích: Whitelist field types hợp lệ cho class-diagram-analyst
> Builder đọc file này để tạo `knowledge/payload-types.md`

---

## 1. Bảng Field Types Hợp lệ
...
Danh sách types hợp lệ để gán vào `type:` field trong YAML Contract:
...
Khi viết `classDiagram`, dùng ký hiệu như sau:
