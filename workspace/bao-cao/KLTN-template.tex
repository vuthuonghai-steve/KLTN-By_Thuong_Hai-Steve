...
\textbf{Từ khóa:} AI Agent (Tác vụ AI), Agent Skill Framework, Next.js 15, Payload CMS, Steve Void, Software Engineering (Kỹ nghệ phần mềm).
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Chuẩn hóa quy trình làm việc: mọi developer trong team sử dụng chung một bộ Skills, giúp đồng nhất phương pháp (consistency) trước khi tiến hành sản xuất.
...
Nhằm kiểm chứng chất lượng thiết kế, Skill Architect tích hợp cơ chế Self-Scoring — AI tự đánh giá từng section của \texttt{design.md} theo thang điểm 1-5. Các tiêu chí đánh giá bao gồm: độ rõ ràng (Clarity), tính đầy đủ (Completeness), tính khả thi (Feasibility), và tuân thủ chuẩn (Standards Compliance).
