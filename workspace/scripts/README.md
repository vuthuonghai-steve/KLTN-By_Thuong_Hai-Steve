...
Package `steve-void-setup.zip` bao gồm:
...
| Agent | Mô Tả |
|-------|-------|
| `pipeline-orchestrator` | Điều phối multi-stage pipeline |
| `skill-executor` | Thực thi skill với isolated context |
| `spec-reviewer` | Review code vs specs |
| `payload-expert` | PayloadCMS specialist |
| `ui-architect` | UI/UX architect |
